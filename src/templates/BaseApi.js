...
class BaseApi {
    constructor(sockets) {
        ...
        /** @namespace module:persistance.pubsub */
        this.sockets = sockets;
        /**
         * Publish a payload to a topic for all subscribed microservices.
         * @method module:persistance.pubsub#publish
